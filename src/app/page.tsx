  ...
  return (
    <div className="min-h-screen overflow-hidden bg-[#f7f7f7] text-[#101014]">
      ...
      <section id="pricing" className="mx-auto max-w-[1120px] px-6 pb-24">
        ...
        <div className="mx-auto mt-10 grid max-w-[760px] gap-5 md:grid-cols-2"><article className="rounded-3xl border border-black/10 bg-white p-7"><div className="text-xs font-semibold uppercase tracking-[.12em] text-black/45">Free</div><div className="mt-3 text-4xl font-bold">€0</div><p className="mt-2 text-sm text-black/55">Explore roles, sources, and your first workspace.</p><ButtonLink href="/onboarding" className="mt-6 w-full !rounded-full !bg-black !py-3">Start free</ButtonLink></article><article className="rounded-3xl border-2 border-[#6538f2] bg-[#f4f0ff] p-7"><div className="text-xs font-semibold uppercase tracking-[.12em] text-[#6538f2]">Pro</div><div className="mt-3 text-4xl font-bold">€12<span className="text-sm font-medium text-black/45"> / month</span></div><p className="mt-2 text-sm text-black/55">Multiple role CVs, bulk preparation, and application tracking.</p><ButtonLink href="/onboarding" className="mt-6 w-full !rounded-full !bg-[#6538f2] !py-3">Build your workspace</ButtonLink></article></div>
      </section>
